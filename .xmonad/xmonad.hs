...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- open power menu
    , ((controlMask .|. modm, xK_Delete), spawn "source ~/.local/bin/rofi-power.sh")
...
myLayout = do
    ...
    --spacingRaw False (Border 10 0 10 0) True (Border 0 10 0 10) True $ Tall (1 (3/100) (1/2)) ||| Full
    --; tiled ||| Mirror tiled ||| Full
     --   where 
            --tiled = Tall 1 1/2 9/100
            --nmaster ratio delta
